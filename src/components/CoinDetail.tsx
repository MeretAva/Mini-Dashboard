      ...
      {coin && (
        <div className="space-y-4">
          ...
          <div className="space-y-1 text-sm">
            <p><span className="text-gray-500">Current Price: </span>
              <strong>{formatPrice(coin.market_data.current_price.eur)}</strong></p>
            <p><span className="text-gray-500">Market Cap Rank: </span>
              <strong>#{coin.market_data.market_cap_rank}</strong></p>
            <p><span className="text-gray-500">24h High / Low: </span>
              <strong>
                {formatPrice(coin.market_data.high_24h.eur)} / {formatPrice(coin.market_data.low_24h.eur)}
              </strong>
            </p>
          </div>
          ...
          {coin.description.en && (
            <div>
              ...
              <p className="text-sm text-gray-600">{shorten(coin.description.en)}</p>
            </div>
          )}
